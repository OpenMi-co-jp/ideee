class IdeasController < ApplicationController
  ...
  def index
    ...
    @liked_ideas = @ideas.most_liked
    @most_viewed_ideas = @ideas.most_viewed
    @most_commented_ideas = @ideas.most_commented
  ...
  def search
    ...
    list = Idea.includes([:idea_tags]).search(name: params[:keyword], difficulty: params[:difficulty]).order("#{sort}": "DESC")
