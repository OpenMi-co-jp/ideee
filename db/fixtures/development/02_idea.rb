...
15.times do |n|
  ...
  Idea.seed(
    :id,
    { id: num, name: Faker::JapaneseMedia::Doraemon.gadget , note: Faker::Lorem.paragraph(sentence_count: 20), icon: File.open(carriwave_path) , user: User.find(num), view: (0..200).to_a.sample },
  )
  Idea.seed(
    :id,
