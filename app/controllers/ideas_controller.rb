class IdeasController < ApplicationController
  prepend_before_action :set_idea, only: %i[ show edit update destroy publish cooperation_start cooperation_complete cooperation_start_confirm cooperation_restart ]
