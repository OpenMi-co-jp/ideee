...
export type AiIdeaTitles = {
  __typename?: 'AiIdeaTitles';
  /** AIアイデアタイトル */
...
export type Query = {
  ...
  /** AIによるアイデアタイトル一覧 */
  aiIdeaTitles: Array<AiIdeaTitles>;
  /** コメントオブジェクト */
  comment: Comment;
  /** コメントアイデア一覧 */
...
export type UpdateTeamInput = {
  ...
  ideaId: Scalars['ID'];
  /** メンバー数 */
  membersNum?: InputMaybe<Scalars['Int']>;
  /** (メンバーが)得られるもの */
...
export type GetAiIdeaTitlesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAiIdeaTitlesQuery = { __typename?: 'Query', aiIdeaTitles: Array<{ __typename?: 'AiIdeaTitles', title: string }> };
...
export const GetAiIdeaTitlesDocument = gql`
    query GetAiIdeaTitles {
  aiIdeaTitles {
    title
  }
}
...
/**
 * __useGetAiIdeaTitlesQuery__
 *
 * To run a query within a React component, call `useGetAiIdeaTitlesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAiIdeaTitlesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAiIdeaTitlesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAiIdeaTitlesQuery(baseOptions?: Apollo.QueryHookOptions<GetAiIdeaTitlesQuery, GetAiIdeaTitlesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAiIdeaTitlesQuery, GetAiIdeaTitlesQueryVariables>(GetAiIdeaTitlesDocument, options);
      }
export function useGetAiIdeaTitlesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAiIdeaTitlesQuery, GetAiIdeaTitlesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAiIdeaTitlesQuery, GetAiIdeaTitlesQueryVariables>(GetAiIdeaTitlesDocument, options);
        }
export type GetAiIdeaTitlesQueryHookResult = ReturnType<typeof useGetAiIdeaTitlesQuery>;
export type GetAiIdeaTitlesLazyQueryHookResult = ReturnType<typeof useGetAiIdeaTitlesLazyQuery>;
export type GetAiIdeaTitlesQueryResult = Apollo.QueryResult<GetAiIdeaTitlesQuery, GetAiIdeaTitlesQueryVariables>;
